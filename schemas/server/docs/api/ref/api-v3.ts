...
export interface external {
  ...
  "requestBodies/fields_tags_lc.yaml": {
  ...
  "responses/response-status/response_status.yaml": {
    /**
    ...
    warnings?: (external["responses/response-status/warning-or-error.yaml"])[];
    /** @description List of errors. Errors are used to alert about something that is definitely wrong (e.g. a nutrient value thaty is impossibly high). */
    errors?: (external["responses/response-status/warning-or-error.yaml"])[];
  }
  "responses/response-status/warning-or-error.yaml": {
    message?: {
  ...
  "schemas/packagings/input_taxonomy_tag.yaml": string
  "schemas/packagings/material-write.yaml": {
  ...
  "schemas/packagings/packaging_component-write.yaml": {
    /** @description Number of units of this packaging component contained in the product (e.g. 6 for a pack of 6 bottles) */
    number_of_units?: number;
    shape?: external["schemas/packagings/shape-write.yaml"];
    material?: external["schemas/packagings/material-write.yaml"];
    recycling?: external["schemas/packagings/recycling-write.yaml"];
    ...
    weight_specified?: OneOf<[number, string]>;
    ...
    weight_measured?: OneOf<[number, string]>;
  ...
  "schemas/packagings/packagings-write.yaml": (external["schemas/packagings/packaging_component-write.yaml"])[]
  "schemas/packagings/packagings.yaml": readonly (external["schemas/packagings/packaging_component.yaml"])[]
  "schemas/packagings/recycling-write.yaml": {
    /** @description Canonical id of the entry in the taxonomy. If the value cannot be mapped to a taxonomy entry, the value must be the name of the entry in its original language prefixed by the language 2 letter code and a colon. */
    id?: string;
  } | {
    /** @description Name of the entry in the language specified in the tags_lc field of the request. If the translation is not available, the value must be the name of the entry in its original language prefixed by the language 2 letter code and a colon. */
  ...
  "schemas/packagings/shape-write.yaml": {
    /** @description Canonical id of the entry in the taxonomy. If the value cannot be mapped to a taxonomy entry, the value must be the name of the entry in its original language prefixed by the language 2 letter code and a colon. */
    id?: string;
  } | {
    /** @description Name of the entry in the language specified in the tags_lc field of the request. If the translation is not available, the value must be the name of the entry in its original language prefixed by the language 2 letter code and a colon. */
  ...
  "schemas/product_update_api_v3.yaml": {
    packagings?: external["schemas/packagings/packagings-write.yaml"];
    packagings_add?: external["schemas/packagings/packagings-write.yaml"];
    ...
    categories_tags?: (external["schemas/packagings/input_taxonomy_tag.yaml"])[];
  }
...
export interface operations {
  ...
  "patch-api-v3-product-barcode": {
    ...
    requestBody?: {
      content: {
        "application/json": external["requestBodies/lc_cc.yaml"] & external["requestBodies/fields_tags_lc.yaml"] & {
          user_id?: string;
          password?: string;
          product?: external["schemas/product_update_api_v3.yaml"];
        };
    ...
    responses: {
      ...
      200: {
        ...
        content: {
          "application/json": external["responses/response-status/response_status.yaml"] & {
            product?: external["schemas/product.yaml"];
          };
        };
      };
  ...
  "get-api-v3-taxonomy_suggestions-taxonomy": {
    parameters: {
      query: {
        tagtype?: external["api.yml"]["components"]["parameters"]["tagtype"];
