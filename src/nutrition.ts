...
export class NutritionValidator {
   ...
   */
  private validateEnergyConsistency(
    nutriments: Record<string, any>,
    warnings: NutritionWarning[],
  ): void {
   ...
   */
  private validateFatConsistency(
    nutriments: Record<string, any>,
    warnings: NutritionWarning[],
  ): void {
   ...
   */
  private validateCarbohydratesConsistency(
    nutriments: Record<string, any>,
    warnings: NutritionWarning[],
  ): void {
   ...
   */
  private validateSaltSodiumConsistency(
    nutriments: Record<string, any>,
    warnings: NutritionWarning[],
  ): void {
